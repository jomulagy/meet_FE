  ...
  return (
    ...
    >
      ...
      <section className="px-6">
        <div className="relative overflow-hidden rounded-[26px] bg-gradient-to-br from-[#6358FF] via-[#7A6CFF] to-[#A68BFF] px-6 pb-8 pt-7 text-white shadow-lg">
          <div className="relative z-[1] flex flex-col gap-3">
            ...
            <Link
              to="/meet/list"
              className="mt-2 inline-flex w-fit items-center gap-2 rounded-full bg-white px-4 py-2 text-[12px] font-semibold text-[#5E5CE6] shadow-md transition hover:shadow-lg"
            >
              모임 둘러보기
      ...
      <section className="px-6 mt-10 flex flex-col gap-4 text-[#1C1C1E]">
        ...
        <div className="grid gap-4">
          <article className="rounded-[22px] bg-white p-5 shadow-[0_8px_24px_rgba(26,26,26,0.06)]">
            <h4 className="text-[14px] font-semibold text-[#5856D6]">모임 준비</h4>
            <p className="mt-2 text-[13px] text-[#636366]">
              일정과 장소 투표를 동시에 받아보고, 구성원들의 참여 여부를 한눈에 확인하세요.
            </p>
          </article>
          <article className="rounded-[22px] bg-white p-5 shadow-[0_8px_24px_rgba(26,26,26,0.06)]">
            <h4 className="text-[14px] font-semibold text-[#5856D6]">모임 운영</h4>
            <p className="mt-2 text-[13px] text-[#636366]">
